...
public class Client
{
    ...
    public static List<Action> stonevoxcalls = new List<Action>();
    ...
    public static void beginstonevox()
    {
        ...
        try
        {
            window = new GLWindow(1280, 720, new GraphicsMode(new ColorFormat(32), 8, 0, 8));
        }
        catch (Exception ex)
        {
    ...
    public static void update()
    {
        ...
        while(stonevoxcalls.Count > 0)
        {
            stonevoxcalls[0].Invoke();
            stonevoxcalls.RemoveAt(0);
        }
    }
